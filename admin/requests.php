                            ...
                            <div class="col-md-4 my-3">
                                <center>
                                    <a href="issue_requests.php" class="btn btn-info">
                                        <image class="rounded float-left" width="100px" src="images/book2.png"></image>
                                        <p>Issue Requests</p>
                                    </a>
                                </center>
                            </div>
                            <div class="col-md-4 my-3">
                                <center>
                                    <a href="renew_requests.php" class="btn btn-info">
                                        <image class="rounded mx-auto d-block" width="100px" src="images/book3.png"></image>
                                        <p>Renew Request</p>
                                    </a>
                                </center>
                            </div>
                            <div class="col-md-4 my-3">
                                <center>
                                    <a href="return_requests.php" class="btn btn-info">
                                        <image class="rounded float-right" width="100px" src="images/book4.png"></image>
                                        <p>Return Requests</p>
                                    </a>
                                </center>
                            </div>
