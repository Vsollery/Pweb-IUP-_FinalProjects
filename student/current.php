    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row flex-nowrap">
                ...
                <div class="col mt-5">
                    <div class="container-fluid">
                        <h1 class="text-center mb-3">Currently Issued Books</h1>
                        ...
                        if (isset($_POST['submit'])) {
                            $s = $_POST['title'];
                            $sql = "select * from pwebfp.record,pwebfp.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId and (record.BookId='$s' or Title like '%$s%')";
                        } else
                            $sql = "select * from pwebfp.record,pwebfp.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId";
