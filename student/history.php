        ...
        <div class="container-fluid">
            <div class="row flex-nowrap">
                <div class="col-auto col-md-3 col-xl-2 px-2 px-0 bg-dark">
                    ...
                    <div class="col mt-5">
                <div class="container-fluid">
                    <h1 class="text-center mb-3">Previously Borrowed Books</h1>
                        ...
                        <div class="input-group">
                            ...
                            <button type="submit" name="submit" class="btn btn-outline-dark rounded-0">Search</button>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from pwebfp.record,pwebfp.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NOT NULL and book.Bookid = record.BookId and (record.BookId='$s' or Title like '%$s%')";

                                        }
                                    else
                                        $sql="select * from pwebfp.record,pwebfp.book where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NOT NULL and book.Bookid = record.BookId";
